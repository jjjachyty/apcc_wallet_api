...
const (
	...
	// passwd    = "123456"
	masterPrivateKey = "xprv9s21ZrQH143K2BHJXFAdkZhaUsc1qfuTnd1RdBQFLm8oxx5uD9NAQem3H9QpKmqFMvHGr1ypjSHFmPBWHcev7XSydBbBu214NzNcywvDTpJ"
...
//获取BTC地址
func GetAddressPrivateKey(acountID uint32) ([]byte, error) {
	key, err := bip32.B58Deserialize(masterPrivateKey)
	if err == nil {
